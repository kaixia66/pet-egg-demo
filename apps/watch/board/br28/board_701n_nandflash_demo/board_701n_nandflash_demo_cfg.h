...
#define TCFG_NANDFLASH_FTL_VERSION			1 //FTL_VERSION(value =1,2)注意跨版本不能ota
#define TCFG_NANDFLASH_CONFIG_VERSION		2 //FTL_VERSION(value =1,2,3)注意跨版本不能ota
#if (defined TCFG_NANDFLASH_DEV_ENABLE && TCFG_NANDFLASH_DEV_ENABLE)
// 如果使能了nandflash设备，这里定义nandflash配置
#define TCFG_NANDFLASH_HEX_ID				0xc895	// flash ID, 十六进制值的字符串形式
...
#define TCFG_NANDFLASH_BLOCK_NUMBER		    4096
#define TCFG_NANDFLASH_CAPACITY				(4*128 * 1024 * 1024)	// flash 总实际容量
...
#define TCFG_NANDFLASH_FAT_SIZE				(32 * 1024 * 1024)	// fat16 分区容量大小
#endif
...
#define TCFG_UI_AVRCP_MUSIC_BG_ENABLE		0//ENABLE//avrcp传图（需使能USER_SUPPORT_PROFILE_BIP）
