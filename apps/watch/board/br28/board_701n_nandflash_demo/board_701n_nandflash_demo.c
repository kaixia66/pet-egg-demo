...
#if TCFG_LCD_SPI_SH8601A_ENABLE || TCFG_LCD_SPI_ICNA3310B_ENABLE ||TCFG_LCD_SPI_CO5300_v1_ENABLE
...
#if TCFG_NOR_VM
/* nandflash ui_vm 区配置（因使用 norflash 的逻辑，故使用NOR宏） */
NORFLASH_SFC_DEV_PLATFORM_DATA_BEGIN(nandflash_fs_vm_dev_data)
#if (TCFG_FLASH_DEV_SPI_HW_NUM == 1)
    .sfc_spi_pdata  = &spi1_p_data,
#elif (TCFG_FLASH_DEV_SPI_HW_NUM == 2)
    .sfc_spi_pdata  = &spi2_p_data,
#endif
...
REGISTER_DEVICES(device_table) = {
...
#if (TCFG_VIRFAT_FLASH_ENABLE && !TCFG_NANDFLASH_DEV_ENABLE)
	...
	// nandflash 使用virfat文件系统
	{"virfat_flash", 	&virfat_flash_dev_ops, 	(void *)"nandflash_ftl"},
#endif

#if TCFG_NOR_VM
	// nandflash ui_vm区
	{"ui_vm",			&nandflash_fs_ftl_ops,	(void *)&nandflash_fs_vm_dev_data},
#endif
...
#endif /* #ifdef CONFIG_BOARD_701N_NANDFLASH_DEMO */
