...
//                                  SD 配置                                        //
//*********************************************************************************//
#define TCFG_SD0_ENABLE						(!TCFG_FUNC_TINY_ENABLE)//SD0模块使能
...
/*PA*/
#define TCFG_AUDIO_DAC_PA_PORT				IO_PORTC_05
/*
DAC硬件上的连接方式,可选的配置：
...
#define TCFG_MOTO_PWM_IO                    IO_PORTC_02
//*********************************************************************************//
//                                  时钟配置                                       //
//*********************************************************************************//
...
#define TCFG_USER_EMITTER_ENABLE            (!TCFG_FUNC_TINY_ENABLE)   //emitter功能使能
...
//                           编解码格式配置(CodecFormat)                           //
//*********************************************************************************//
#define TCFG_DEC_MP3_ENABLE                 (!TCFG_FUNC_TINY_ENABLE)
...
//                                  fat 文件系统配置                                       //
//*********************************************************************************//
#define CONFIG_FATFS_ENABLE					(!TCFG_FUNC_TINY_ENABLE)
#define TCFG_LFN_EN                         (!TCFG_FUNC_TINY_ENABLE)
...
#define TCFG_UI_ENABLE_MENU_STAR_NEW		(TCFG_UI_ENABLE &&ENABLE)//新满天星
...
//*********************************************************************************//
#if TCFG_FUNC_TINY_ENABLE
#define TCFG_SDFILE_VFS_REDUCE_ENABLE			1 //SDFILE精简。1-删除fscan/file接口，fopen等不受影响
#define TCFG_AUDIO_STREAM_FRAME_COPY_ENABLE		0 //数据流分流。0-关闭分流。1-打开分流，列如输出到dac和蓝牙发射
#else
#define TCFG_SDFILE_VFS_REDUCE_ENABLE			0 //SDFILE精简。1-删除fscan/file接口，fopen等不受影响
#define TCFG_AUDIO_STREAM_FRAME_COPY_ENABLE		1 //数据流分流。0-关闭分流。1-打开分流，列如输出到dac和蓝牙发射
#endif
