...
const char log_tag_const_v_APP_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_APP_CAT1 AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_d_APP_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_APP_CAT1 AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_e_APP_CAT1 AT(.LOG_TAG_CONST) = TRUE;

const char log_tag_const_v_CAT1_UPDATE AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_CAT1_UPDATE AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_d_CAT1_UPDATE AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_CAT1_UPDATE AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_e_CAT1_UPDATE AT(.LOG_TAG_CONST) = TRUE;
...
const char log_tag_const_v_SMART_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_SMART_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_d_SMART_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_SMART_CAT1 AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_e_SMART_CAT1 AT(.LOG_TAG_CONST) = TRUE;
...
const char log_tag_const_v_IFLY_ASR AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_IFLY_ASR AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_d_IFLY_ASR AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_IFLY_ASR AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_e_IFLY_ASR AT(.LOG_TAG_CONST) = FALSE;
