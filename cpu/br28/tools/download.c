...
#if (defined(TCFG_NANDFLASH_FTL_VERSION)&&(TCFG_NANDFLASH_FTL_VERSION==2))
cp br28_loader_ftlv2.bin br28loader.bin
#else
cp br28_loader_ftlv1.bin br28loader.bin
#endif
...
#if (defined(TCFG_NANDFLASH_FTL_VERSION)&&(TCFG_NANDFLASH_FTL_VERSION==2))
copy br28_loader_ftlv2.bin br28loader.bin
#else
copy br28_loader_ftlv1.bin br28loader.bin
#endif
