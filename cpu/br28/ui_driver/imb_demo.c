...
*/
/*----------------------------------------------------------------------------*/
struct imb_task *imb_create_gif_task(int task_id, void *fp, struct image_file *file, u32 priv, int (*read)(int keyframe, void *fp, int offset, u8 *data, int len), int x, int y, int width, int height)
{
    struct imb_task_info imb_tsk_info = {0};
...
static int gif_custom_read(int keyframe, void *fp, int offset, u8 *data, int len)
{
