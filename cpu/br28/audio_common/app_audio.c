...
#if TCFG_APP_CAT1_EN
        if (true == cat1_call_use_modem_volume()) {
            cat1_call_set_modem_volume(volume);
            break;
        }
...
#if TCFG_APP_CAT1_EN
        if (true == cat1_call_use_modem_volume()) {
            app_var.call_volume = cat1_call_get_modem_volume();
            printf("[%s]cat1_srv_voice_get_volume = %d.", __func__, app_var.call_volume);
        }
#endif /* #if TCFG_APP_CAT1_EN */
